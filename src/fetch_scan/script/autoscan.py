...
def main(args):
    ...
    while True:
        ...
        while True:
            ...
            target_pose.orientation.x = max_q[1]
            target_pose.orientation.y = max_q[2]
            target_pose.orientation.z = max_q[3]
            target_pose.orientation.w = max_q[0]
...
if __name__ == '__main__':
    args_dict = {
        ...
        'roi_bbox':[0.3, -0.5, 0.1, 1.3, 0.5, 1.1],
        'vox_res': 0.05,
        'ros_rate': 2.0,
        'cam_dist': 0.2,
        'init_pose': {'x': 0.0851,
